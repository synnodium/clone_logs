    ...
    cursor.executemany(
        ...
        (
            (
                ...
                p("class_stats.heavyweapons.total_time"),
                p("class_stats.heavyweapons.kills"),
                p("class_stats.heavyweapons.assists"),
                p("class_stats.heavyweapons.deaths"),
                p("class_stats.heavyweapons.dmg"),
                ...
                d(f"classkills.{id}.heavyweapons"),
                d(f"classkillassists.{id}.heavyweapons"),
                d(f"classdeaths.{id}.heavyweapons"),
